...
public class Eqianbao2HeMr {
    ...
    public static class MyMapper extends TableMapper<Text, Text> {
        ...
        protected void map(ImmutableBytesWritable row, Result value, Context context) throws IOException, InterruptedException {
            ...
            if (REAL_NAME != null && !"".equals(REAL_NAME) && !"null".equals(REAL_NAME)) {
    ...
    public static class MyReducer extends TableReducer<Text, Text, NullWritable> {  //  ImmutableBytesWritable
        ...
        protected void reduce(Text key, Iterable<Text> values, Context context) throws IOException, InterruptedException {
            ...
            for (Map<String, String> map : lists1) {
                ...
                put.add("c".getBytes(), "source".getBytes(), Bytes.toBytes("e签宝"));
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        scan1.addColumn(Bytes.toBytes("c"), Bytes.toBytes("project"));
        scan1.addColumn(Bytes.toBytes("c"), Bytes.toBytes("Etime"));
        ...
        scan1.setAttribute(Scan.SCAN_ATTRIBUTES_TABLE_NAME, Bytes.toBytes("e_qianbao_data_24h_formal"));  //  e_qianbao_data_24h_formal e_qianbao_data_1m_test
        ...
        scans.add(scan2);
        TableMapReduceUtil.initTableMapperJob(scans, Eqianbao2HeMr.MyMapper.class, Text.class, Text.class, job);

        TableMapReduceUtil.initTableReducerJob("ewe", Eqianbao2HeMr.MyReducer.class, job);
