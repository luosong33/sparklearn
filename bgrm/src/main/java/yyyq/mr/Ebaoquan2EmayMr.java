...
public class Ebaoquan2EmayMr extends Configured {
    /**
    ...
    public static class MyReducer extends TableReducer<Text, Text, NullWritable> {  //  ImmutableBytesWritable
        ...
        protected void reduce(Text key, Iterable<Text> values, Context context) throws IOException, InterruptedException {
            ...
            put.add("c".getBytes(), "count_ebaoquan".getBytes(), Bytes.toBytes(i + ""));
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        scan1.setAttribute(Scan.SCAN_ATTRIBUTES_TABLE_NAME, Bytes.toBytes("ebaoquan_24h_formal"));
...
//        scan1.setStopRow(Bytes.toBytes(args[0] + "~"));
        ...
        TableMapReduceUtil.initTableReducerJob("ebaoquan_24h_emay_2017", MyReducer.class, job);
