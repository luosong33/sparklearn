...
import yyyq.util.{CsUtil, DateUtil}

import scala.collection.JavaConversions._
import scala.collection.immutable.{ListMap, TreeMap}
import scala.collection.mutable.ArrayBuffer

object HastenMatchingRepeat {

  def main(args: Array[String]): Unit = {
    val conf = new SparkConf().setMaster("yarn") //  yarn  local[4]
      .setAppName("HastenMatching_date_repeat") // HastenMatching_date_upgrade HastenMatching_date
    conf.set("spark.streaming.kafka.maxRatePerPartition", "4")
    conf.set("spark.streaming.backpressure.enabled", "true")
    val ssc = new StreamingContext(conf, Seconds(5))

    val topics = Set("MOXIE_CARRIER_ACCESS_SUMMIT_REPEAT")
    ...
    val kafkaParams = Map[String, String](
      ...
      "group.id" -> "HastenMatching_date_repeat",
    ...
    val events = kafkaStream.map(line => {
      ...
      try {
        ...
        origDate = moxieLog.getString("creditDate") // 获取原始时间
    ...
    events.foreachRDD(rdd => {
      rdd.foreachPartition(partitionOfRecords => {
        ...
        val table = new HTable(hconf, "hasten_matching_test") //  hasten_matching_test
        ...
        table.close()*/
        partitionOfRecords.foreach(pair => {
          val strarr1 = pair._1.split("\\|")
          val strarr2 = pair._2.split("\\|")
          val hastenMatching = new HastenMatchingEntity()
          hastenMatching.setClientNo(strarr1(0))
          hastenMatching.setCreditNo(strarr1(1))
          hastenMatching.setPhoneNum_10(strarr2(0) + "")
          hastenMatching.setCallNum_10(strarr2(1) + "")
          hastenMatching.setPhoneNum_20(strarr2(2) + "")
          hastenMatching.setCallNum_20(strarr2(3) + "")
          hastenMatching.setPhoneNum_30(strarr2(4) + "")
          hastenMatching.setCallNum_30(strarr2(5) + "")
          hastenMatching.setPhoneNum_90(strarr2(6) + "")
          hastenMatching.setCallNum_90(strarr2(7) + "")
          hastenMatching.setPhoneNum_180(strarr2(8) + "")
          hastenMatching.setCallNum_180(strarr2(9) + "")
          hastenMatching.setOrigDate(strarr2(10))
          hastenMatching.setNowDate(strarr2(11))
          hastenMatching.setProportion30(strarr2(12) + "")
          hastenMatching.setTop10Num(strarr2(13) + "")
          hastenMatching.setPhoneNum_180_fortyThousand(strarr2(14) + "")
          hastenMatching.setPhoneNum_90_fortyThousand(strarr2(15) + "")
//          val csUtil = new CsUtil()
